...
│   ├── 01_qc/                   # Quality control step
│   │   ├── slurm_out/           # SLURM log files
│   │   ├── 01_fastqc_one_sample.sh
│   │   └── 01_fastqc_array.sbatch
│   ├── 02_preprocessing/        # Preprocessing step
│   │   ├── slurm_out/
│   │   ├── 02_trim_one_sample.sh
│   │   └── 02_trim_array.sbatch
...
```bash
# Submit all samples as parallel tasks
...
# Call your one-sample script from the same directory
...
* Submit: `sbatch scripts/01_qc/01_fastqc_array.sbatch`
